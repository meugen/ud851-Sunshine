...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherDataView = (TextView) findViewById(R.id.tv_weather_data);

        // COMPLETED (3) Create an array of Strings that contain fake weather data
        final String[] fakeWeatherData = { "Sunny", "Raining", "Snowing" };

        // COMPLETED (4) Append each String from the fake weather data array to the TextView
        for (String fakeWeatherItem : fakeWeatherData) {
            weatherDataView.append(fakeWeatherItem + "\n\n");
        }
    }
}