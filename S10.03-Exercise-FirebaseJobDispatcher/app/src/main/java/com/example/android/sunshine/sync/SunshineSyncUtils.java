...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int SUNSHINE_SYNC_INTERVAL_HOURS = 3;
    private static final int SUNSHINE_SYNC_INTERVAL_SECONDS = (int) TimeUnit
            .HOURS.toSeconds(SUNSHINE_SYNC_INTERVAL_HOURS);
    private static final int SUNSHINE_SYNC_PERIOD_MINUTES = 30;
    private static final int SUNSHINE_SYNC_PERIOD_SECONDS = (int) TimeUnit
            .MINUTES.toSeconds(SUNSHINE_SYNC_PERIOD_MINUTES);

    private static boolean sInitialized;

//  COMPLETED (11) Add a sync tag to identify our sync job
    private static final String SUNSHINE_SYNC_TAG = "sunshine";

//  COMPLETED (12) Create a method to schedule our periodic weather sync
    private static void initPeriodicSync(final Context context) {
        ...
        final Job job = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(SUNSHINE_SYNC_INTERVAL_SECONDS,
                        SUNSHINE_SYNC_INTERVAL_SECONDS + SUNSHINE_SYNC_PERIOD_SECONDS))
                .setRecurring(true)
